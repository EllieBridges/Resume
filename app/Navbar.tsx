...
const Navbar = () => {
  return (
    <nav id='navbar' className='flex flex-row w-100 sticky inset-x-0 top-0 bg-gradient-to-r from-pink to-purple text-white p-2'>
      ...
      <Link href='/' className='text-green text-xl font-black hover:text-white'>
        Home
        </Link>
        </div>
  <div id='separator' className='basis-0 lg:basis-1/5 xl:basis-2/5'></div>
      <div id='navSelection' className='basis-4/5 flex flex-row justify-right justify-evenly'>
        ...
        <Link href='tictactoe' className='hover:font-bold'>
          TicTacToe
          </Link>
          <Link href='feelgood' className='hover:font-bold'>
          Feel good
          </Link>
