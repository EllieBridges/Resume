    ...
    return (
        <ShadowContainer>
            <div className='flex flex-wrap justify-center'>
                <h1 className='w-full  font-primary font-black text-purple md:text-2xl md:pr-2'>{company}</h1>
                ...
                <ul className='font-secondary text-black'>
                    {points.map((point, i) => {
                        return (
                            <li key={i} className='list-disc text-xs sm:text-sm m-2 md:text-justify'>{point}</li>
                        )
                    })}
                </ul>
            </div>
