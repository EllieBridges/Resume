...
const AnimateOnScroll = ({ children, reappear, threshold = 0.5 }: Props) => {
  ...
  return (
    <>
      <div ref={containerRef} className={`transition duration-1000 ${isVisible ? "opacity-100 blur-none translate-x-0" : "opacity-0 blur-lg -translate-x-20"} flex justify-center w-100 my-10 motion-reduce:transition-none motion-reduce:hover:transform-none lg:my-20`}>
        {children}
      </div>
    </>
  );
