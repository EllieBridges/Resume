...
const Profile = ({ id, title, content, subtitle, color, photoUrl, photoSize }: { id: string, title: string, content: string, subtitle: string, color: string, photoUrl: string, photoSize: number }) => {
    return (
        < ShadowContainer >
            ...
            <Image id='profilePic' className='object-top justify-center m-5 md:scale-125' src={photoUrl} alt='A black and white photo of me' width={photoSize} height={photoSize} />
        </ShadowContainer >
    )
}
