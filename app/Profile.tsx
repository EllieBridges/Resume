    ...
    return(
        ...
        data-te-animation="[slide-right_1s_ease-in-out]">
            ...
            <div className='container flex flex-col lg:w-1/2'>
                ...
                <div className='m-5'>
                <h3 className={`font-secondary text-sm text-${colour} text-base text-justify sm:text-lg`}>{subtitle}</h3>
                <h3 className={`font-secondary text-sm text-${colour} text-base text-justify sm:text-lg`}>{content}</h3>
                </div>
            </div>
